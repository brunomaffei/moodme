import brazilTexture from '../../assets/makeUp/brasilMask.png'

import franceTexture from '../../assets/makeUp/sportMakeup.png'

import portugalTexture from '../../assets/makeUp/portugalMask.png'

import belgiumTexture from '../../assets/makeUp/belgiumMask.png'
...
const borderHardness = {
  ...
  export const BRAZIL = {
    ...
    GLSLFragmentSource: "void main(void){\n\
      ...
      float brighness = 0.5 * dot(videoColor, vec3(0.299, 0.587, 0.114));\n\
      brighness = clamp(brighness, 0.1, 0.4);\n\
      ...
      //gl_FragColor = vec4(1.1*videoColor, 1.0);\n\
    }",
